...
- **Bento-grid dashboard** with hero card, hourly chart, 7-day forecast, rain forecast, and Storm Watch panel
- **Real atmospheric data** via Open-Meteo's free public API — no API key required
- **Geolocation auto-detect** with graceful Chicago fallback
...
- [x] Storm Watch panel (CAPE, pressure trend, wind compass, dewpoint comfort)
- [x] Rain intelligence card with 24h precipitation timeline
